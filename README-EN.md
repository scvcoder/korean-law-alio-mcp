...
## v1.0.7 — Bridging Public-Institution Regulations with Korean National Law
...
### Method 2: Use directly in Claude.ai web (simple, recommended)
...
![Claude custom connector setup screen](./claude-connector.png)
