...
> **추천 동선**: 안정성을 위해 **로컬 모드를 권장**합니다 (방법 1, 3, 4). 가벼운 시도라면 방법 2.
> 로컬 모드는 [사전 준비](#사전-준비--nodejs-방법-1-3-4-사용자) 의 Node.js 설치가 먼저 필요합니다.

### 사전 준비 — Node.js (방법 1, 3, 4 사용자)

> 방법 2 (Claude.ai 웹) 만 쓴다면 이 섹션 건너뛰세요.

본 MCP 서버는 Node.js 위에서 동작합니다. **Node.js 20 이상** 필요.
